                    ...
                    <div class="card-body">
                        ...
                        <select class="form-select" id="id_request" name="id_request">
                          <option value="">Open this select menu</option>
                            @foreach ($bhpRequests as $bhpRequest)
                                <option value="{{ $bhpRequest->id_request }}">{{ $bhpRequest->user->name }} - {{ $bhpRequest->request_date }}</option>
                            @endforeach
                        </select>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" id="id_bhp" name="id_bhp">
                          <option value="">Open this select menu</option>
                            @foreach ($bhps as $bhp)
                                <option value="{{ $bhp->id_bhp }}">{{ $bhp->name_bhp }} - {{ $bhp->unit->name_unit }}</option>
                            @endforeach
                        </select>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control" id="quantity_requested" name="quantity_requested" placeholder="Isikan Tahun Ajaran" />
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="referensi" name="referensi" placeholder="Isikan Tahun Ajaran" />
                        </div>
